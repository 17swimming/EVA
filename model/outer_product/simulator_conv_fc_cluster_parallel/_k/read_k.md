...
使用simulator_real_compute_k.py作为simulator_real_compute.py
...
```
```powershell
python -X utf8 simulator_runner.py --network QKFormer_DVSGesture --num_cores 6 --num_pus 16 --num_clusters 1 --bank_h 12 --bank_w 12 --retire_column 3 --T 16  --simulator cluster_parallel --enabled_modes 0,1,2  --split_fifo_depth 4
```
```powershell
python -X utf8 simulator_runner.py --network SpikeBRGNet_DDD17 --num_cores 6 --num_pus 16 --num_clusters 1 --bank_h 12 --bank_w 12 --retire_column 3 --T 5 --simulator cluster_parallel --enabled_modes 0,1,2  --split_fifo_depth 4
```
```powershell
python -X utf8 simulator_runner.py --network EMSYOLO_GEN1 --num_cores 6 --num_pus 16 --num_clusters 1 --bank_h 12 --bank_w 12 --retire_column 3 --T 5 --simulator cluster_parallel --enabled_modes 0,1,2  --split_fifo_depth 4
```
```powershell
python -X utf8 simulator_runner.py --network SDTrack_FE108 --num_cores 6 --num_pus 16 --num_clusters 1 --bank_h 12 --bank_w 12 --retire_column 3 --T 4 --simulator cluster_parallel --enabled_modes 0,1,2  --split_fifo_depth 4
```
...
- 每个 Cin tile 启动时，Split 后生成第一个 package，要下一拍才能被 Core 读取，固定延迟1拍。
- mode1/2 也占据split周期，对应处理拍可能使 FIFO 读空。
